...
public final class IjkMediaPlayer extends AbstractMediaPlayer {
    ...
    ///////////////////////////////////////////////
    public native void lm_rtspRecordVideo(String url,String path);
    public native void lm_rtspSetRecodeStop(boolean stop);
    public native void lm_rtspSetSoundStop(boolean stop); // 这个是停止录制声音
    public native void lm_rtspRecordSound(String filename, String path); //文件名 文件要存储的路径
